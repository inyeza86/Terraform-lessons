# Terraform Lifecycle Rules – Complete Reference

## Table of Contents
- [Introduction](#introduction)
- [What Are Lifecycle Rules?](#what-are-lifecycle-rules)
- [Where Lifecycle Rules Apply](#where-lifecycle-rules-apply)
- [Lifecycle Arguments](#lifecycle-arguments)
  - [`prevent_destroy`](#prevent_destroy)
  - [`create_before_destroy`](#create_before_destroy)
  - [`ignore_changes`](#ignore_changes)
  - [`replace_triggered_by`](#replace_triggered_by)
- [Combining Lifecycle Rules](#combining-lifecycle-rules)
- [Real-World Examples](#real-world-examples)
- [Common Pitfalls](#common-pitfalls)
- [Best Practices](#best-practices)
- [When Not to Use Lifecycle Rules](#when-not-to-use-lifecycle-rules)
- [Summary](#summary)
...
Terraform lifecycle rules provide fine-grained control over **how Terraform manages resources** during create, update, and destroy operations.

They are especially useful for:
- Preventing accidental deletion of critical infrastructure
- Enabling zero-downtime deployments
- Handling externally-managed or dynamic attributes
- Forcing replacements when Terraform cannot infer dependencies

---

## What Are Lifecycle Rules?

Lifecycle rules are **meta-arguments** defined inside a `resource` block that influence Terraform’s behavior.

They **do not change the infrastructure itself**, only how Terraform treats it.
...
## Where Lifecycle Rules Apply
 ...
 - Only inside resource blocks

 - Not supported in module, variable, or provider blocks

 - Evaluated during plan and apply
